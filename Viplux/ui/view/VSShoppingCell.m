...
//  Viplux
//
//  Created by xiangying on 14-6-3.
//  Copyright (c) 2014年 Vip. All rights reserved.
//

#import "VSShoppingCell.h"

@interface VSShoppingCell() <UIGestureRecognizerDelegate>
...
- (void)setConstraintsToShowAllButtons:(BOOL)animated notifyDelegateDidOpen:(BOOL)notifyDelegate
{
    ...
    self.contentViewRightConstraint.constant = buttonTotalWidth;
    [self.myContentView setFrame:CGRectMake(-buttonTotalWidth, 0, self.frame.size.width, self.frame.size.height)];
...
//        [self.myContentView setFrame:CGRectMake(0, 0, self.frame.size.width, self.frame.size.height)];
        return;
    }
...
//                        self.myContentView.frame = CGRectMake(constant, 0, self.myContentView.frame.size.width, self.myContentView.frame.size.height);
                    }
                } else {
