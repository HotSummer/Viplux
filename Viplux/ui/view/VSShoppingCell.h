...
@class VSShoppingCell;

#pragma mark - Data Source
@protocol VSSwipeableCellDataSource <NSObject>
@required
/**
...
@protocol VSSwipeableCellDelegate <NSObject>
 ...
 */
@interface VSShoppingCell : UITableViewCell
...
@property (nonatomic, weak) id <VSSwipeableCellDelegate> delegate;
@property (nonatomic, weak) id <VSSwipeableCellDataSource> dataSource;
